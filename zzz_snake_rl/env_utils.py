...
# 训练参数
REPLAY_BUFFER_SAVE_EPISODE = int(os.getenv('REPLAY_BUFFER_SAVE_EPISODE', '10'))
...
TRAIN_BUFFER_SIZE = int(os.getenv('TRAIN_BUFFER_SIZE', '1000'))  # 普通训练 缓存大小
TRAIN_BATCH_SIZE = int(os.getenv('TRAIN_BATCH_SIZE', '32'))  # 普通训练 每次更新前的采样数量
